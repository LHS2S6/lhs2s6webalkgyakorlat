				...
				for (int k=0; k<a.get(i).getFloors().get(j).getWings().size(); k++) {
					...
					for (int l=0; l<a.get(i).getFloors().get(j).getWings().get(k).getRooms().size(); l++) {
						System.out.println(l+1+
											": Hotel name: "+a.get(i).getName()+
											", Floor: "+a.get(i).getFloors().get(j).getFloorNumber()+
											", Wing: "+a.get(i).getFloors().get(j).getWings().get(k).getRooms().get(l).getWing()+
											", Room Number: "+a.get(i).getFloors().get(j).getWings().get(k).getRooms().get(l).getNumber()+
											", Beds: "+a.get(i).getFloors().get(j).getWings().get(k).getRooms().get(l).getBeds()+
											", Room Price: "+a.get(i).getFloors().get(j).getWings().get(k).getRooms().get(l).getPrice());
					}
				}
			}
		}
				...
				for (int j=0; j<a.get(i).getFloors().size(); j++) {
					...
					for (int k=0; k<a.get(i).getFloors().get(j).getWings().size(); k++) {
							...
							System.out.println(a.get(i).getName()+
												", Floor: "+a.get(i).getFloors().get(j).getFloorNumber()+
												", Wing: "+a.get(i).getFloors().get(j).getWings().get(k).getRooms().get(r.get(l).getId()-1).getWing()+
												", Room Number: "+a.get(i).getFloors().get(j).getWings().get(k).getRooms().get(r.get(l).getId()-1).getNumber()+
												", Beds: "+a.get(i).getFloors().get(j).getWings().get(k).getRooms().get(r.get(l).getId()-1).getBeds());
			...
			for (int j=0; j<a.get(i).getFloors().size(); j++) {
				...
				for (int k=0; k<a.get(i).getFloors().get(j).getWings().size(); k++) {
						...
						System.out.println(a.get(i).getName()+
											...
											", Room Number: "+a.get(i).getFloors().get(j).getWings().get(k).getRooms().get(index).getNumber()+
											", Beds: "+a.get(i).getFloors().get(j).getWings().get(k).getRooms().get(index).getBeds());
